...
function initMap() {
    try {
        ...
        document.getElementById("map").innerHTML = "Error loading Google Maps. Please check your internet connection and try again.";
    }
}
...
function findNearestMTR(address, lat, lng) {
    ...
    .catch(error => {
        ...
        document.getElementById('result').innerHTML = `<p class="text-danger">An error occurred: ${error.message}. Please try again.</p>`;
    });
}
